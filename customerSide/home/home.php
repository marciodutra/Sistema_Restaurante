    ...
    <div class="nav-bar">
      <div class="brand">
          <a class="nav-link" href="../home/home.php#hero">
            <h1 class="text-center" style="font-family:Copperplate; color:whitesmoke;"> Márcio Dutra</h1><span class="sr-only"></span>
          </a>
      </div>
      <div class="nav-list">
        <div class="hamburger">
        ...
        <ul>
          ...
          <li><a href="../CustomerReservation/reservePage.php" data-after="Service">Reserva</a></li>
          <li><a href="../../adminSide/StaffLogin/login.php" data-after="Staff">Funcionários</a></li>
          
          
   

        <div class="dropdown">
            <button class="dropbtn">CONTA <i class="fa fa-caret-down" aria-hidden="true"></i> </button>
...
<section id="hero" style="position: relative;">
    ...
    <div class="hero container" style="position: relative; z-index: 1;">
        <div>
            <h1><strong><h1 class="text-center" style="font-family:Copperplate; color:whitesmoke;"> Márcio Dutra</h1><span></span></strong></h1>
            <h1><strong style="color:white;">Bar e Restaurante<span></span></strong></h1>
...
<!-- End Hero Section -->
  ...
  <section id="projects">
    <div class="projects container">
      <div class="projects-header">
       ...
       <select style="text-align:center;" id="menu-category" class="menu-category">
        <option  value="blue">TODOS OS ITENS</option>
        <option value="yellow">PRATOS PRINCIPAIS</option>
        <option value="red">ACOMPANHAMENTOS</option>
    ...
    <div class="yellow msg"> 
        ...
        <div></div>
      <div class="mainDish">
           <h1 style="text-align:center;">PRATOS PRINCIPAIS</h1>
    ...
    <div class="red msg">
        <div></div>
      <div class="sideDish">
           <h1 style="text-align:center">ACOMPANHAMENTOS</h1>
...
<section id="about" ">
  <div class="about container">
    <div class="col-right">
        ...
        <h2>Márcio Dutra RESTAURANTE E BAR História da Empresa:</h2>
        <p>Márcio Dutra RESTAURANTE E BAR é um estabelecimento de comida ocidental bem estabelecido no coração da cidade. O Márcio Dutra RESTAURANTE E BAR tornou-se uma escolha popular para clientes que procuram celebrar ocasiões especiais ou simplesmente desfrutar de uma refeição relaxante, com foco em fornecer refeições deliciosas e uma experiência gastronómica amigável.
 </p>
 <p>O Márcio Dutra RESTAURANTE E BAR, como restaurante ocidental, oferece um cardápio diversificado que atende a uma variedade de gostos. O cardápio inclui uma ampla variedade de opções, como petiscos, saladas, sopas e uma variedade de pratos principais. Os clientes podem saborear opções suculentas como bife e costela, frango, cordeiro, frutos do mar, hambúrgueres e sanduíches, massas e uma variedade de deliciosos acompanhamentos. O menu foi cuidadosamente selecionado para oferecer um equilíbrio entre favoritos clássicos e criações inovadoras, garantindo que todos os paladares fiquem satisfeitos.
 </p>
 <p>A capacidade do Márcio Dutra RESTAURANTE E BAR de acomodar clientes é um de seus diferenciais. O Márcio Dutra RESTAURANTE E BAR se esforça para criar um ambiente de jantar convidativo e confortável, quer os hóspedes prefiram entrar ou fazer reservas com antecedência. O restaurante reconhece a importância de criar experiências memoráveis, especialmente para quem celebra ocasiões especiais. O Márcio Dutra RESTAURANTE E BAR é uma escolha popular para famílias, casais e grupos de amigos devido à sua equipe atenciosa e ambiente acolhedor.
 </p>
 <p>O Márcio Dutra RESTAURANTE E BAR tem um convidativo bar ao ar livre, aberto sete dias por semana, das 11h00 às 22h00, além da área de refeições interna. Este espaço ao ar livre oferece um ambiente descontraído para os clientes relaxarem e socializarem. enquanto saboreia suas bebidas favoritas e come petiscos de bar. O bar serve uma grande variedade de bebidas, incluindo coquetéis, vinhos, cervejas e opções não alcoólicas.
 </p>
...
<section id="contact" ">
  <div class="contact container">
    <div>
      <h1 class="section-title">Contato <span>informações</span></h1>
    </div>
    <div class="contact-items">
      ...
      <div class="contact-item contact-item-bg">
        <div class="contact-info">
          ...
          <h1>Endereço</h1>
          <h2>Lote 62, Terceiro Andar, Jalan Newton, No.345, Lorong Kluang, Kota Kinabalu, Malásia, 88000</h2>
        </div>
      </div>
    </div>
  </div>
...
<!-- End Contact Section -->
  ...
  <section id="footer">
    <div class="footer container">
        <div class="brand">
          <h1>Bebidas por conta da casa</h1>
      </div>
      ...
      <p>© 2024 Márcio Dutra Restaurante e Bar</p>
