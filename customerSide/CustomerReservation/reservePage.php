...
<head>
    ...
    <title>Reserva do Cliente </title>
    <style>
...
<body>
    ...
    <div class="reserve-container">
        <a class="nav-link" href="../home/home.php#hero">
            <h1 class="text-center" style="font-family: Copperplate; color: whitesmoke;">Márcio Dutra Restaurante e Bar</h1>
        ...
        <div class="row">
            <div class="column">
                <div id="Search Table">
                    <h2 style=" color:white;">Pesquise por dia e hora</h2>
                 
                    <form id="reservation-form" method="GET" action="availability.php"><br>
                        <div class="form-group">
                        <label for="reservation_date" style="">Escolha o dia</label><br>
                        <input class="form-control" type="date" id="reservation_date" name="reservation_date" required>
                        </div>
                        <div class="form-group">
                        <label for="reservation_time" style="">Horários de reserva disponíveis</label>
                        <div id="availability-table">
                            ...
                            echo '<option value="" selected disabled>Selecione o horário</option>';
                        ...
                        <button type="submit" style="background-color: black; color: rgb(234, 234, 234); " class="btn" name="submit" >Pesquisar</button>
                    </form>
                </div>
            </div>
            ...
            <div class="column right-column">
                <div id="insert-reservation-into-table">
                    <h2 style=" color:white;">Fazer reserva</h2>
                    <form id="reservation-form" method="POST" action="insertReservation.php">
                        <br>
                        <div class="form-group">
                            <label for="customer_name" style="">Nome do cliente</label><br>
                        ...
                        <div class="form-group " >
                            <label for="reservation_date" style="">Data da Reserva</label><br>
                        ...
                        <div class="form-group">
                            <label for="table_id_reserve" style="">Tabelas Disponíveis</label>
                        ...
                        <div class="form-group mb-3">
                            <label for="special_request">Pedido especial</label><br>
                            <textarea class="form-control"  id="special_request" name="special_request"> </textarea><br>
                            <button type="submit" style="background-color: black; color: rgb(234, 234, 234); " class="btn" type="submit" name="submit">Fazer reserva</button>
                        </div>
                    </form>
                </div>
            </div>
