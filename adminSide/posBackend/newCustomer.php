...
<head>
    ...
    <title>Assentos do restaurante</title>
    <!-- Add Bootstrap CSS -->
...
<div class="container mt-5 text-center">
    ...
    if (isset($_GET['new_customer']) && $_GET['new_customer'] === 'true') {
        ...
        if ($link->query($insertQuery) === TRUE) {
            ...
            echo "<h2>Márcio Dutra Restaurante e Bar</h2>";
            echo "<p>Agora você está sentado na Tabela ID: $table_id</p>";
            echo "<p>Sua fatura foi criada com Bill ID: $bill_id</p>";
            echo '<a href="orderItem.php?bill_id=' . $bill_id . '&table_id=' . $table_id . '" class="btn btn-primary">Voltar</a>';
        } else {
