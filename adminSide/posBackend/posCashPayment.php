        ...
        <div class="col-md-8">
            <div class="card mt-4">
                <div class="card-header">
                    <h3 class="card-title">Fatura (pagamento em dinheiro)</h3>
                </div>
                <div class="card-body">
                    <h5>ID da fatura: <?php echo $bill_id; ?></h5>
            ...
            ?>
                    ...
                    <div class="text-right">
                        <?php 
                        echo "<strong>Total:</strong> R$ " . number_format($cart_total, 2) . "<br>";
                        echo "<strong>Taxa (10%):</strong> R$ " . number_format($cart_total * $tax, 2) . "<br>";
                        $GRANDTOTAL = $tax * $cart_total + $cart_total;
                        echo "<strong>Total a pagar:</strong> R$ " . number_format($GRANDTOTAL, 2);
                        ?>
                    </div>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <form action="" method="get">
                ...
                <button type="submit" id="cardSubmit" class="btn btn-dark mt-2">Pagar</button>
            </form>
        </div>
        <div class="col-md-6">
        <?php
            ...
            if ($billCheckResult) {
                if ($billCheckResult->num_rows > 0) {
                    ...
                    if ($billRow['payment_time'] !== null) {
                        ...
                        echo "Faturar com ID $bill_id já foi pago.</div>";
                        echo '<br><a href="posTable.php" class="btn btn-dark">Voltar às tabelas</a>';
                        echo '<br><a href="receipt.php?bill_id=' . $bill_id . '" class="btn btn-light">Imprimir recibo <span class="fa fa-receipt text-black"></span></a>';
