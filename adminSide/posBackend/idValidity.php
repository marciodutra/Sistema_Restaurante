...
<html>
<head>
    <title>Verifique a validade da reserva dos membros da equipe</title>
    <!-- Add Bootstrap CSS -->
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
</head>
<body>
    <div class="container mt-5">
        <h2 class="text-center">Verifique a validade da reserva dos membros da equipe</h2>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (!$result) {
            ...
            if ($staffExists && $memberExists && $reservationExists) {
                ...
                echo "Funcionários, membros e reservas são válidos.";
                echo '</div>';
                echo '<div class="mt-3">';
                echo '<a href="posCashPayment.php?bill_id=' . $bill_id . '&staff_id=' . $staffId . '&member_id=' . $memberId . '&reservation_id=' . $reservationId . '" class="btn btn-success">Dinheiro</a>';
                echo '<a href="posCardPayment.php?bill_id=' . $bill_id . '&staff_id=' . $staffId . '&member_id=' . $memberId . '&reservation_id=' . $reservationId . '" class="btn btn-primary ml-2">Cartão de crédito</a>';
                echo '</div>';
            } else {
